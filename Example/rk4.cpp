...
double RK4::rk4 ( double t0, double u0, double dt, double f ( double t, double u ) )
...
double *RK4::rk4vec ( double t0, int m, double u0[], double p[], double dt, double *f ( double t, int m, double u[], double params[]) )
