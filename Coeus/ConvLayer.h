...
namespace Coeus
{
	...
	{
	public:
		ConvLayer(const string& p_id, ACTIVATION p_activation, TensorInitializer* p_initializer, int p_filters, int p_extent, int p_stride, int p_padding, initializer_list<int> p_in_dim = {0});
		~ConvLayer();
